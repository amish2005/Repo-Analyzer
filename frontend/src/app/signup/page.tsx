...
import { Code2, GitBranch, Mail, Lock, User } from "lucide-react";
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md sharp-panel p-8 relative rounded-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm">Start deeply understanding codebases today.</p>
        </div>
        ...
        <form className="flex flex-col gap-4">
          ...
          <Link href="/dashboard" className="w-full bg-white hover:bg-zinc-200 text-black py-3 rounded-md font-bold transition-all mt-2 text-center block">
            Create account
          </Link>
        </form>
